namespace Physicist
{
    ...
    public class MainGame : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            GameSprite testSprite = new GameSprite(texture, new Vector2(19, 35), 0.1f);
            testSprite.AddAnimation(new SpriteAnimation(0, 8, 1));
            testSprite.CurrentAnimationIndex = 0;

namespace Physicist.Types.Camera
{
    using System;
    ...
    public class CameraController : ICamera
    {
        ...
        public CameraController(Vector2 position, IReadOnlyPosition following, float zoom, float rotation, Vector2 bounds)
        {
            this.Bounds = bounds;
        ...
        public IReadOnlyPosition Following { get; set; }
        ...
        public Matrix Transform
        {
            get
            {
                ...
                {
                    return this.translationMatrix * this.originScaleRotationMatrix * Matrix.CreateTranslation(this.Viewport.ViewportSize.Width / 2, this.Viewport.ViewportSize.Height / 2, 0);
                }
                else
                {

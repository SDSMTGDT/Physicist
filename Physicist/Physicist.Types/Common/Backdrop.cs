    ...
    public class Backdrop : IBackgroundObject, IDraw
    {
        ...
        public void XmlDeserialize(XElement element)
        {
            if (element != null)
            {
                ...
                this.Dimensions = XmlDeserializeHelper.XmlDeserialize<Size>(element.Element("Dimension"));
                ...
                {
                    this.Texture = this.Texture.TileTexture(this.Dimensions, this.Texture.GraphicsDevice);

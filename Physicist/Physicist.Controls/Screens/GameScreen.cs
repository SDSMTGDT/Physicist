namespace Physicist.Controls.Screens
{
    ...
    using Viewport = Physicist.Types.Camera.Viewport;
    ...
    public partial class GameScreen : IGameScreen
    {
        ...
        public void InitializeScreen(GraphicsDevice graphicsDevice) 
        {
            ...
            {
                Viewport = new Viewport(new Size(this.GraphicsDevice.Viewport.Width, this.GraphicsDevice.Viewport.Width)),
                Bounds = new Vector2(GraphicsDevice.Viewport.Width * 2, GraphicsDevice.Viewport.Height * 2),
            };
